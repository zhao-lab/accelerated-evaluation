...
IS_10000=load('IS_information_pedestrian_Raw_10000.mat','S_0','S_1','A_I','A_O','K','mu_data','sigma_data','eta_data');
IS_10000_refined=load('IS_information_pedestrian_Refined_10000','refined_A_I','refined_A_O');
IS_1000=load('IS_information_pedestrian_Raw_1000.mat','S_0','S_1','A_I','A_O','K','mu_data','sigma_data','eta_data');
IS_1000_refined=load('IS_information_pedestrian_Refined_1000','refined_A_I','refined_A_O');
...
disp(runningStep);
pause(1);
output_4_raw_5=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_raw_rho_5(:,1),IS_4_samples_raw_rho_5(:,2),IS_4_samples_raw_rho_5(:,3),RMin );
% output_4_raw_1=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_raw_rho_1(:,1),IS_4_samples_raw_rho_1(:,2),IS_4_samples_raw_rho_1(:,3),RMin );
% output_4_raw_0=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_raw_rho_0(:,1),IS_4_samples_raw_rho_0(:,2),IS_4_samples_raw_rho_0(:,3),RMin );
output_3_raw_5=pedestrian_model_vector_adaptive_rdot(  IS_3_samples_raw_rho_5(:,1),IS_3_samples_raw_rho_5(:,2),IS_3_samples_raw_rho_5(:,3),RMin );

% Refined IS
runningStep = runningStep + 1;
disp(runningStep);
pause(1);
output_4_refined_5=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_refined_rho_5(:,1),IS_4_samples_refined_rho_5(:,2),IS_4_samples_refined_rho_5(:,3),RMin );
% output_4_refined_1=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_refined_rho_1(:,1),IS_4_samples_refined_rho_1(:,2),IS_4_samples_refined_rho_1(:,3),RMin );
% output_4_refined_0=pedestrian_model_vector_adaptive_rdot(  IS_4_samples_refined_rho_0(:,1),IS_4_samples_refined_rho_0(:,2),IS_4_samples_refined_rho_0(:,3),RMin );
output_3_refined_5=pedestrian_model_vector_adaptive_rdot(  IS_3_samples_refined_rho_5(:,1),IS_3_samples_refined_rho_5(:,2),IS_3_samples_refined_rho_5(:,3),RMin );
...
disp(runningStep);
pause(1);
[outer_appr_4_raw_5 inner_appr_4_raw_5]=pedestrian_monotone_approaximate( IS_4_samples_raw_rho_5(:,1),IS_4_samples_raw_rho_5(:,2),IS_4_samples_raw_rho_5(:,3),S_0,S_1,monotone_direction);
% [outer_appr_4_raw_1 inner_appr_4_raw_1]=pedestrian_monotone_approaximate( IS_4_samples_raw_rho_1(:,1),IS_4_samples_raw_rho_1(:,2),IS_4_samples_raw_rho_1(:,3),S_0,S_1,monotone_direction);
% [outer_appr_4_raw_0 inner_appr_4_raw_0]=pedestrian_monotone_approaximate( IS_4_samples_raw_rho_0(:,1),IS_4_samples_raw_rho_0(:,2),IS_4_samples_raw_rho_0(:,3),S_0,S_1,monotone_direction);
[outer_appr_3_raw_5 inner_appr_3_raw_5]=pedestrian_monotone_approaximate( IS_3_samples_raw_rho_5(:,1),IS_3_samples_raw_rho_5(:,2),IS_3_samples_raw_rho_5(:,3),S_0,S_1,monotone_direction);

% Refined IS
runningStep = runningStep + 1;
disp(runningStep);
pause(1);
[outer_appr_4_refined_5 inner_appr_4_refined_5]=pedestrian_monotone_approaximate( IS_4_samples_refined_rho_5(:,1),IS_4_samples_refined_rho_5(:,2),IS_4_samples_refined_rho_5(:,3),S_0,S_1,monotone_direction);
% [outer_appr_4_refined_1 inner_appr_4_refined_1]=pedestrian_monotone_approaximate( IS_4_samples_refined_rho_1(:,1),IS_4_samples_refined_rho_1(:,2),IS_4_samples_refined_rho_1(:,3),S_0,S_1,monotone_direction);
% [outer_appr_4_refined_0 inner_appr_4_refined_0]=pedestrian_monotone_approaximate( IS_4_samples_refined_rho_0(:,1),IS_4_samples_refined_rho_0(:,2),IS_4_samples_refined_rho_0(:,3),S_0,S_1,monotone_direction);
[outer_appr_3_refined_5 inner_appr_3_refined_5]=pedestrian_monotone_approaximate( IS_3_samples_refined_rho_5(:,1),IS_3_samples_refined_rho_5(:,2),IS_3_samples_refined_rho_5(:,3),S_0,S_1,monotone_direction);
...
filename = ['afterrunning_simulation_compare_pedestrian20171212_with_rng_' num2str(randNumber)];
save(filename);