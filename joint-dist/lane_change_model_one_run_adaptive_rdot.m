function [ nCrashL ] = lane_change_model_one_run_adaptive_rdot( vLIni,X_Rdot,X_InvR,RMin )
%UNTITLED9 Summary of this function goes here
%   Detailed explanation goes here
    

    TTCIni = 1/X_InvR/X_Rdot;
    RLIni = 1/X_InvR;
    RRLIni = max(-30,-X_Rdot); % I forgot why it is -23.49 m/s
