IS_info=load('IS_information_Lane_Change_Raw_1000.mat','S_0','S_1','A_I','A_O','K','mu_data','sigma_data','eta_data');
...
save('IS_information_Lane_Change_Refined_1000','refined_A_I','refined_A_O')