...
fitting_data=load('fitting_result_leftTurn_K_from_3_to_23.mat','eta_ite','mu_ite','sigma_ite');
astar=[0 0 0];
bstar=[30 60 150];
rng(123)
...
%     input_data=data_samples.*fitting_data.var_Std+fitting_data.center;
    %%%===============================================================================================
    data_samples=[rand(N_data_iter,1)*30,rand(N_data_iter,1)*60,rand(N_data_iter,1)*150];
    %%%===============================================================================================
    input_data=data_samples;
    %%%===============================================================================================
    index_indicator=left_turn_model_vector_adaptive_rdot(  input_data(:,1),input_data(:,2),input_data(:,3),0);  % where we use the simulation
...
filename = ['IS_information_Left_turn_Raw_' num2str(N_data_iter) '.mat'];
