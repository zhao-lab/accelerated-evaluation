...
fitting_data=load('fitting_result_pedestrian_K_from_3_to_22.mat','eta_ite','mu_ite','sigma_ite');
astar=[0 -7 5];
bstar=[13 6 60];
rng(123)
...
%%%===============================================================================================
data_samples=[rand(N_data_iter,1)*13,rand(N_data_iter,1)*13-7,rand(N_data_iter,1)*55+5];
%%%===============================================================================================
input_data=data_samples;
%%%===============================================================================================
index_indicator=pedestrian_model_vector_adaptive_rdot(  input_data(:,1),input_data(:,2),input_data(:,3),0);  % where we use the simulation
...
filename = ['IS_information_pedestrian_Raw_' num2str(N_data_iter) '.mat'];
save(filename,'S_0','S_1','A_I','A_O','K','mu_data','sigma_data','eta_data');