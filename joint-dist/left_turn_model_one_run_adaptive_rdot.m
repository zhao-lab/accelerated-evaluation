...
function [crash] = left_turn_model_one_run_adaptive_rdot(vh,vl,R,RMin,controllerParameters)
...
Ts = 0.1;
turningRadius = 6; % turning radius should be larger than laneWidth
laneWidth = 3.9;
...
lx0 = laneWidth-(1-cos(alphaRadius-betaRadius))*turningRadius;
